//
//  HomeFifthDayCollectionViewCell.swift
//  FNFA
//
...
class HomeFifthDayCollectionViewCell: UICollectionViewCell {
    ...
    override func awakeFromNib() {
        ...
        filteredEvents = (modelController?.getEventsByDate(events: (modelController?.events)!, date: "dimanche 8"))!
    }

//
//  HomeThirdDayCollectionViewCell.swift
//  FNFA
//
...
class HomeThirdDayCollectionViewCell: UICollectionViewCell {
    ...
    override func awakeFromNib() {
        ...
        filteredEvents = (modelController?.getEventsByDate(events: (modelController?.events)!, date: "vendredi 6"))!
    }

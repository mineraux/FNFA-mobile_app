//
//  HomeFourthDayCollectionViewCell.swift
//  FNFA
//
...
class HomeFourthDayCollectionViewCell: UICollectionViewCell {
    ...
    override func awakeFromNib() {
        ...
        filteredEvents = (modelController?.getEventsByDate(events: (modelController?.events)!, date: "samedi 7"))!
    }

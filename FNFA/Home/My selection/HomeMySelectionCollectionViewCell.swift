//
//  HomeMySelectionCollectionViewCell.swift
//  FNFA
//
...
class HomeMySelectionCollectionViewCell: UICollectionViewCell {
    ...
    override func awakeFromNib() {
        ...
        filteredEvents = (modelController?.getEventsInFav())!
    ...
    @IBAction func favAction(_ sender: Any) {
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "reloadData"), object: nil)
         ...
         NotificationCenter.default.post(name: NSNotification.Name(rawValue: "reloadDataHomeTableView"), object: nil)
